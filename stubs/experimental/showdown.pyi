...
class showdown(Plugin):
    ...
    def handle_automatic_showdown(self, alive_r: list[Player], alive_b: list[Player]) -> None: ...
    ...
    def should_reactivate_normal_game(self, alive_r: list[Player], alive_b: list[Player]) -> bool: ...
    ...
    def should_activate_gauntlet_showdown(self, alive_r: list[Player], alive_b: list[Player]) -> bool: ...
    def should_skip_automatic_showdown_this_round(self, alive_r: list[Player], alive_b: list[Player]) -> int: ...
    def activate_showdown(self, alive_r: list[Player], alive_b: list[Player], showdown_weapon: str = ...) -> None: ...
    def start_showdown(self) -> None: ...
    def allow_music(self) -> bool: ...
    def announce_player_died(self, alive_r: list[Player], alive_b: list[Player]) -> None: ...
    def other_team(self, team: str) -> str: ...
    def handle_death(self, _victim: Player, _killer: Player | None, _data: dict) -> None: ...
    def handle_round_start(self, _round_number: int) -> None: ...
    def handle_round_end(self, _data: RoundEndData) -> None: ...
    def cmd_showdown(self, player: Player, msg: list[str], _channel: AbstractChannel) -> None: ...
