...
class openai_bot(Plugin):
    ...
    async def _completion(self, messages: str | list[dict[str, str]]) -> ChatCompletion | None: ...
    def _gather_completion(self, messages: str | list[dict[str, str]]) -> str | None: ...
    @staticmethod
    ...
    def cmd_list_models(self, player: Player, _msg: list[str], _channel: AbstractChannel) -> None: ...
    def _list_models_in_thread(self, player: Player) -> None: ...
    def cmd_switch_model(self, player: Player, msg: list[str], _channel: AbstractChannel) -> int: ...
