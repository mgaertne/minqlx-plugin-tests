...
class env_dmg(Plugin):
    ...
    def scan_targetting_entities(self, entity_id: int, means_of_death: int, timestamp: Timestamp) -> None: ...
    def handle_death(self, victim: Player, killer: Player | None, _data: DeathData) -> None: ...
