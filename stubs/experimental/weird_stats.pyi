from typing import NamedTuple, Generic, TYPE_CHECKING
from minqlx import Plugin

if TYPE_CHECKING:
    from typing import Callable, TypeVar, Iterator, Sequence, Literal
...
class PlayerStatsEntry:
    stats_data: list[PlayerStatsStats]
    def __init__(self, stats_data: PlayerStatsStats) -> None: ...
...
def random_medal_facts(
    stats: list[PlayerStatsEntry], *, count: int = ...
) -> list[str]: ...
...
class weird_stats(Plugin):
    ...
    def handle_death(self, victim: Player, killer: Player, data: DeathData) -> None: ...
    ...
    def gather_team_shots_summary(self) -> list[str]: ...
    ...
    def identify_target(
        self, player: Player, target: str | int | Player
    ...
    def collect_and_report_player_top_speeds(
        self, channel: AbstractChannel, steam_id: int
    ) -> None: ...
    ...
    def collect_and_report_map_top_speeds(
        self, channel: AbstractChannel, mapname: str
    ) -> None: ...
