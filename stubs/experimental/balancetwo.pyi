...
class balancetwo(Plugin):
    ...
    def cmd_balance(self, player: Player, _msg: str, _channel: AbstractChannel) -> int | None: ...
    ...
    def cmd_last_action(self, _player: Player, msg: str, channel: AbstractChannel) -> int | None: ...
    def cmd_teams(self, player: Player, _msg: str, channel: AbstractChannel) -> int | None: ...
    ...
    def cmd_dont(self, _player: Player, _msg: str, _channel: AbstractChannel) -> None: ...
    def cmd_agree(self, player: Player, _msg: str, _channel: AbstractChannel) -> None: ...
    def execute_suggestion(self) -> None: ...
    def cmd_veto(self, player: Player, _msg: str, _channel: AbstractChannel) -> None: ...
    def cmd_nokick(self, player: Player, msg: str, channel: AbstractChannel) -> int | None: ...
    def cmd_switch_privacy_checks(self, _player: Player, msg: str, channel: AbstractChannel) -> int | None: ...
    def disable_policy_check(self, channel: AbstractChannel) -> None: ...
    def enable_policy_check(self, channel: AbstractChannel) -> None: ...
    def cmd_add_exception(self, player: Player, msg: str, _channel: AbstractChannel) -> int | None: ...
    def cmd_del_exception(self, player: Player, msg: str, _channel: AbstractChannel) -> int | None: ...
