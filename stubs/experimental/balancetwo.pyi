...
class balancetwo(Plugin):
    ...
    ) -> tuple[str | None, Awaitable[dict] | None]: ...
    def append_ratings(self, rating_provider_name: str, json_result: dict) -> None: ...
    def cmd_elocheck(self, player: Player, msg: list[str], channel: AbstractChannel) -> int | None: ...
    ...
    def cmd_aliases(self, player: Player, msg: list[str], channel: AbstractChannel) -> int | None: ...
    ...
    def cmd_ratings(self, _player: Player, _msg: list[str], channel: AbstractChannel) -> None: ...
    ...
    def cmd_balance(self, player: Player, _msg: list[str], _channel: AbstractChannel) -> int | None: ...
    ...
    def cmd_last_action(self, _player: Player, msg: list[str], channel: AbstractChannel) -> int | None: ...
    def cmd_teams(self, player: Player, _msg: list[str], channel: AbstractChannel) -> int | None: ...
    def collect_suggestions(
        self, teams: Mapping[str, list[Player]], gametype: str, channel: AbstractChannel
    ) -> None: ...
    def filtered_suggestions(self, teams: Mapping[str, list[Player]], gametype: str) -> list[Suggestion]: ...
    ...
    def possible_switches(self, teams: Mapping[str, list[Player]], gametype: str) -> list[Suggestion]: ...
    def handle_suggestions_collected(self, possible_switches: list[Suggestion], channel: AbstractChannel) -> None: ...
    def rating_strategy(self, _strategy: str) -> SuggestionRatingStrategy: ...
    def cmd_do(self, _player: Player, _msg: list[str], _channel: AbstractChannel) -> None: ...
    def cmd_dont(self, _player: Player, _msg: list[str], _channel: AbstractChannel) -> None: ...
    def cmd_agree(self, player: Player, _msg: list[str], _channel: AbstractChannel) -> None: ...
    def execute_suggestion(self) -> None: ...
    def cmd_veto(self, player: Player, _msg: list[str], _channel: AbstractChannel) -> None: ...
    def cmd_nokick(self, player: Player, msg: list[str], channel: AbstractChannel) -> int | None: ...
    def cmd_switch_privacy_checks(self, _player: Player, msg: list[str], channel: AbstractChannel) -> int | None: ...
    def disable_policy_check(self, channel: AbstractChannel) -> None: ...
    def enable_policy_check(self, channel: AbstractChannel) -> None: ...
    def cmd_add_exception(self, player: Player, msg: list[str], _channel: AbstractChannel) -> int | None: ...
    def cmd_del_exception(self, player: Player, msg: list[str], _channel: AbstractChannel) -> int | None: ...
    ...
    def rating_provider_for(self, rating_provider_name: str) -> SkillRatingProvider | None: ...
    ...
    def handle_team_switch_attempt(self, player: Player, old: str, new: str) -> int | None: ...
    ...
    def find_player_movements_to_even_teams(self) -> list[tuple[Player, str]]: ...
    def handle_game_end(self, data: GameEndData) -> None: ...
    def record_team_stats(self, gametype: str) -> None: ...
    def team_stats(self, team: list[Player], gametype: str) -> dict[SteamId, list[int | float]]: ...
...
class ConnectThread(threading.Thread):
    ...
    def __init__(self, steam_id: SteamId, rating_provider: SkillRatingProvider) -> None: ...
    def run(self) -> None: ...
