...
class custom_modes_vote(Plugin):
    ...
    def handle_vote_called(self, caller: Player, vote: str, args: str) -> CancellableEventReturn: ...
    def handle_vote_ended(self, _votes: tuple[int, int], vote: str, args: str, passed: bool) -> None: ...
    def cmd_switch_mode(self, _player: Player, msg: list[str], _channel: AbstractChannel) -> int: ...
