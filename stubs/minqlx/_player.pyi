...
class Player:
    ...
    @property
    def ping(self) -> int: ...
    def position(self, reset: bool = ..., **kwargs: dict) -> bool | Vector3: ...
    def velocity(self, reset: bool = ..., **kwargs: dict) -> bool | Vector3: ...
    def weapons(self, reset: bool = ..., **kwargs: dict) -> bool | Weapons: ...
    def weapon(self, new_weapon: int | str | None = ...) -> bool | int: ...
    def ammo(self, reset: bool = ..., **kwargs: dict) -> bool | Weapons: ...
    def powerups(self, reset: bool = ..., **kwargs: dict) -> bool | Powerups: ...
    @property
    def holdable(self) -> int: ...
    @holdable.setter
    def holdable(self, value: str | None) -> None: ...
    def drop_holdable(self) -> None: ...
    def flight(self, reset: bool = ..., **kwargs: dict) -> bool | Flight: ...
    @property
    ...
    def tell(self, msg: str, **kwargs: dict) -> None: ...
