...
class merciful_elo_limit(Plugin):
    ...
    def blink2(self, player: Player, message: str, count: int = ..., interval: float = ...) -> None: ...
    def handle_round_start(self, _round_number: int) -> None: ...
    def handle_player_at_round_start(self, player: Player) -> None: ...
    def cmd_mercis(self, _player: Player, _msg: list[str], channel: AbstractChannel) -> None: ...
    def cmd_merci(self, player: Player, msg: list[str], channel: AbstractChannel) -> int: ...
