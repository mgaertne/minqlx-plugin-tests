...
class duelarena(Plugin):
    ...
    def handle_team_switch_event(self, player: Player, _old: str, new: str) -> CancellableEventReturn: ...
    ...
    def cmd_join(self, player: Player, _msg: list[str], _channel: AbstractChannel) -> None: ...
