...
if TYPE_CHECKING:
    ...
    from minqlx import Player, AbstractChannel, CancellableEventReturn
...
class qlstats_privacy_policy(Plugin):
    ...
    def handle_team_switch_attempt(self, player: Player, old: str, new: str) -> CancellableEventReturn: ...
    def cmd_policy_exception(self, player: Player, msg: list[str], channel: AbstractChannel) -> int: ...
    def cmd_switch_plugin(self, _player: Player, msg: list[str], channel: AbstractChannel) -> int: ...
