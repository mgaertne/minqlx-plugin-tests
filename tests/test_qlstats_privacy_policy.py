...
class TestQlstatsPrivacyPolicy:
    ...
    def qlstats_response(self):
        ...
        yield response
        unstub(response, requests.Session)
    ...
    def test_handle_player_connect_dispatches_fetching_of_privacy_settings_from_qlstats(
        ...
        verify(requests.Session).get(f"http://qlstats.net/elo/{connecting_player.steam_id}", timeout=any_())
    ...
    def test_handle_player_connect_logs_error_if_result_status_not_ok(self, qlstats_response):
        ...
        verify(minqlx, atleast=1).console_command(matches(".*QLStatsPrivacyError.*Invalid response code.*"))
    ...
    def test_handle_player_connect_logs_error_if_playerinfo_not_included(self, qlstats_response):
        ...
        verify(minqlx, atleast=1).console_command(matches(".*QLStatsPrivacyError.*Invalid response content.*"))
    ...
    def test_handle_player_connect_logs_error_if_steam_id_not_included(self, qlstats_response):
        ...
        verify(minqlx, atleast=1).console_command(
            matches(".*QLStatsPrivacyError.*Response.*did not include.*requested player.*")
        )
