...
class TestQlstatsPrivacyPolicy:
    ...
    @pytest.mark.usefixtures("game_in_progress")
    def test_handle_player_connect_logs_error_if_result_status_not_ok(
        self, qlstats_response
    ):
    ...
    @pytest.mark.usefixtures("game_in_progress")
    def test_handle_player_connect_logs_error_if_playerinfo_not_included(
        self, qlstats_response
    ):
    ...
    @pytest.mark.usefixtures("game_in_progress")
    def test_handle_player_connect_logs_error_if_steam_id_not_included(
        self, qlstats_response
    ):
    ...
    def test_handle_player_connect_logs_error_if_privacy_information_not_included(
        ...
        verify(minqlx, atleast=1).console_command(
            matches(
                ".*QLStatsPrivacyError.*Response.*did not include.*privacy information.*"
            )
        )
