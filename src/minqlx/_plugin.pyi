...
from typing import Callable, Iterable, Type, overload, ClassVar
...
class Plugin:
    ...
    @classmethod
    def player(cls, name: str | int | minqlx.Player, player_list: list[minqlx.Player] | None = ...) \
            -> minqlx.Player | None: ...
    @classmethod
    ...
    @classmethod
    def colored_name(cls, name: str | minqlx.Player, player_list: list[minqlx.Player] | None = ...) -> str | None: ...
    @classmethod
    def client_id(cls, name: str | int | minqlx.Player, player_list: list[minqlx.Player] | None = ...) \
            -> int | None: ...
    @classmethod
    def find_player(cls, name: str, player_list: list[minqlx.Player] | None = ...) -> list[minqlx.Player]: ...
    @classmethod
    def teams(cls, player_list: list[minqlx.Player] | None = None) -> dict[str, list[minqlx.Player]]: ...
    @classmethod
    def center_print(cls, msg: str, recipient: str | int | minqlx.Player | None = ...) -> None: ...
    @classmethod
    def tell(cls, msg: str, recipient: str | int | minqlx.Player, **kwargs) -> None: ...
    @classmethod
    ...
    @classmethod
    def kick(cls, player: str | int | minqlx.Player, reason: str = ...) -> None: ...
    @classmethod
    ...
    @classmethod
    def play_music(cls, music_path: str, player: minqlx.Player | None = ...) -> bool: ...
    @classmethod
    def stop_sound(cls, player: minqlx.Player | None = ...) -> None: ...
    @classmethod
    def stop_music(cls, player: minqlx.Player | None = ...) -> None: ...
    @classmethod
    def slap(cls, player: str | int | minqlx.Player, damage: int = ...) -> None: ...
    @classmethod
    def slay(cls, player: str | int | minqlx.Player) -> None: ...
    @classmethod
    ...
    @property
    def game(self) -> minqlx.Game | None: ...
    @property
    ...
    def add_command(self, name: str | tuple[str, ...], handler: Callable, permission: int = ...,
                    channels: Iterable[minqlx.AbstractChannel] | None = ...,
                    exclude_channels: Iterable[minqlx.AbstractChannel] = ..., priority: int = ...,
