...
class Player:
    ...
    def __init__(self, client_id: int, info: minqlx.PlayerInfo | None = ...) -> None: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __contains__(self, key: str) -> bool: ...
    def __getitem__(self, key: str) -> str: ...
    def __eq__(self, other: minqlx.Player) -> bool: ...
    def __ne__(self, other: minqlx.Player) -> bool: ...
    ...
    @property
    def state(self) -> minqlx.PlayerState | None: ...
    @property
    ...
    def valid(self) -> bool: ...
    @property
    def stats(self) -> minqlx.PlayerStats | None: ...
    @property
    def ping(self) -> int: ...

    def position(self, reset: bool = ..., **kwargs) -> bool | minqlx.Vector3: ...
    def velocity(self, reset: bool = ..., **kwargs) -> bool | minqlx.Vector3: ...
    def weapons(self, reset: bool = ..., **kwargs) -> bool | minqlx.Weapons: ...
    def weapon(self, new_weapon: int | str | None = ...) -> bool | int: ...
    def ammo(self, reset: bool = ..., **kwargs) -> bool | minqlx.Weapons: ...
    def powerups(self, reset: bool = ..., **kwargs) -> bool | minqlx.Powerups: ...
    ...
    def flight(self, reset: bool = ..., **kwargs) -> bool | minqlx.Flight: ...
    ...
    def tell(self, msg: str, **kwargs) -> None: ...
    ...
    def switch(self, other_player: minqlx.Player) -> None: ...
