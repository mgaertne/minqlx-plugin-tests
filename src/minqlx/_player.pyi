...
from minqlx import PlayerInfo, PlayerState, PlayerStats, Vector3, Weapons, Powerups, Flight, AbstractChannel
...
class Player:
    ...
    def position(self, reset: bool = ..., **kwargs) -> bool | Vector3: ...
    def velocity(self, reset: bool = ..., **kwargs) -> bool | Vector3: ...
    def weapons(self, reset: bool = ..., **kwargs) -> bool | Weapons: ...
    def weapon(self, new_weapon: int | str | None = ...) -> bool | int: ...
    def ammo(self, reset: bool = ..., **kwargs) -> bool | Weapons: ...
    def powerups(self, reset: bool = ..., **kwargs) -> bool | Powerups: ...
    ...
    def flight(self, reset: bool = ..., **kwargs) -> bool | Flight: ...
