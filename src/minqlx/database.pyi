...
class AbstractDatabase:
    ...
    def set_permission(self, player: Player, level: int) -> None: ...
    def get_permission(self, player: Player) -> int: ...
    def has_permission(self, player: Player, level: int = ...) -> bool: ...
    def set_flag(self, player: Player, flag: str, value: bool = ...) -> None: ...
    def clear_flag(self, player: Player, flag: str) -> None: ...
    def get_flag(self, player: Player, flag: str, default: bool = ...) -> bool: ...
...
class Redis(AbstractDatabase):
    ...
    def connect(self, host: str | None = ..., database: int = ..., unix_socket: bool = ...,
                password: str | None = ...) -> redisRedis | None: ...
    def close(self) -> None: ...
