...
class EventDispatcher:
    ...
    def dispatch(self, *args, **kwargs) -> str | bool | Iterable | None: ...
    def handle_return(self, handler: Callable, value: int | str | None) -> str | None: ...
    def add_hook(self, plugin: Plugin | str, handler: Callable, priority: int = ...) -> None: ...
    def remove_hook(self, plugin: Plugin | str, handler: Callable, priority: int = ...) -> None: ...
...
class ChatEventDispatcher(EventDispatcher):
    def dispatch(self, player: Player, msg: str, channel: AbstractChannel) -> str | bool | Iterable | None: ...
...
class PlayerLoadedDispatcher(EventDispatcher):
    def dispatch(self, player: Player): ...


class PlayerDisonnectDispatcher(EventDispatcher):
    def dispatch(self, player: Player, reason: str | None) -> str | bool | Iterable | None: ...
...
class VoteCalledDispatcher(EventDispatcher):
    def dispatch(self, player: Player, vote: str, args: str | None) -> str | bool | Iterable | None: ...
...
class TeamSwitchDispatcher(EventDispatcher):
    def dispatch(self, player: Player, old_team: str, new_team: str) -> str | bool | Iterable | None: ...
...
class KillDispatcher(EventDispatcher):
    def dispatch(self, victim: Player, killer: Player | None, data: Mapping) -> str | bool | Iterable | None: ...
...
class UserinfoDispatcher(EventDispatcher):
    def dispatch(self, playe: Player, changed: Mapping) -> str | bool | Iterable | None: ...
    def handle_return(self, handler: Callable, value: int | str | None) -> str | None: ...
...
class KamikazeExplodeDispatcher(EventDispatcher):
    def dispatch(self, player: Player, is_used_on_demand: bool) -> str | bool | Iterable | None: ...
