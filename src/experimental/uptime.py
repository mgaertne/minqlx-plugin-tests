...
class uptime(Plugin):
    ...
    def cmd_uptime(self, _player, _msg, _channel):
        ...
        self.msg(f"^6Operating system^7: ^5{lsb_info['description']}^7, ^6uptime^7: ^5{os_uptime}^7")
        self.msg(f"^6Quake Live server^7 running with ^5minqlx {minqlx_version}^7 (Python {platform.python_version()}) "
                 f"^6uptime: ^5{qlserver_uptime}^7")
