...
# the ending of the topic generated by the plugin that matches the format of the
# :func:`mydiscordbot.generate_topic(self)` function.
# This topic snipplet is used to keep a static suffix on the idling channels upon changing the topic with the
# current state of the server.
#
# If you change the behavior :func:`mydiscordbot.generate_topic()` function, you may need to change this
# expression, too!
topic_ending = "players."

plugin_version = "v0.9.3"
...
class mydiscordbot(minqlx.Plugin):
    ...
    * qlx_discordExecPrefix (default: ".qlx") command for authenticated users to execute server commands from discord
    ...
    def generate_topic(self):
        ...
        # CAUTION: if you change anything on the next line, you may need to redefine the topic_ending variable to
